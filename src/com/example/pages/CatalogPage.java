...
//		$("a.b-dealers-map-popup-link").click();
//		$("input.b-dealers-map-popup__input").should(appear).val(city);
//		$(By.linkText(city)).should(appear).click();
//		$("div.b-dealers-scroll__btn").should(appear);
//		$("input.b-dealers-map-popup__input").val(dealer);
